var API = (function(API) {
    ...
    API.search = function(data) {
        nuxeoClient.repositoryName('default').operation('API-GenerateMergedCustomerStatements').params(data).execute(
                callbackGeneratePDF);
...
$(document).ready(function() {
    ...
    // The "name" attribute is the same as the name of the variables expected by the automation chain in nuxeo
